...
import Stepper from "@/components/form/StepIndicators";
import {
  ShieldCheck,
  Clock,
  Sparkles,
          ...
          <div className="lg:col-span-7 bg-white p-8 md:p-10 rounded-3xl border border-gray-200/60 shadow-sm">
            {!submittedSuccessfully ? (
              <form onSubmit={formik.handleSubmit} className="space-y-6">
                ...
                <input type="hidden" name="scheduleUrgency" value={scheduleUrgency} />
                ...
                <motion.button
                  ...
                  className={`w-full cursor-pointer rounded-md px-6 py-4 font-bold text-lg text-white transition-all duration-300 flex items-center justify-center gap-2 ${
                    isSubmitting
                      ...
                      : "bg-[#059669] hover:shadow-lg shadow-lg shadow-emerald-200 hover:shadow-xl hover:translate-y-[-1px] active:translate-y-0 group"
                  }`}
                >
                  {isSubmitting
                ...
                <div className="space-y-2">
                  ...
                  {serviceInput && (
                    <p className="text-sm font-medium text-secondary mt-4">
                      Exam/Service: <span className="text-primary">{serviceInput}</span>
                    </p>
                  )}
                  {scheduleUrgency && (
                    <p className="text-sm text-gray-500 mt-2">
                      Priority: <span className="capitalize">{scheduleUrgency}</span>
                    </p>
                  )}
                </div>
              </motion.div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                    ...
                    live sandbox environments and solving active performance-based
                    simulations.
                  </p>
                </div>
              </div>
