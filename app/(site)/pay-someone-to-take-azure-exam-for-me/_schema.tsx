export default function AzureExamFAQSchema() {
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "What types of Azure exams do you support?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We support all major Microsoft Azure proctored exams, including AZ-900 Azure Fundamentals, AZ-104 Azure Administrator, AZ-305 Azure Solutions Architect, AZ-500 Azure Security Engineer, DP-203 Azure Data Engineer, and AI-900 Azure AI Fundamentals."
        }
      },
      {
        "@type": "Question",
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Take My Azure Exam Help Support",
    alternateName: "Online Proctored Microsoft Azure Exam Support Service",
    ...
    serviceType: "Take Azure Online Support",
    category: "Education Support Services",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Take My Azure Exam Support Plans",
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Take Azure AZ-900 Exam for Me",
            url: "https://www.testhelpnow.com/pay-someone-to-take-azure-exam-for-me/take-my-azure-az-900-exam-for-me",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Take Azure AZ-104 Exam for Me",
            url: "https://www.testhelpnow.com/pay-someone-to-take-azure-exam-for-me/take-my-azure-az-104-exam-for-me",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Take Azure AZ-305 Exam for me",
            url: "https://www.testhelpnow.com/pay-someone-to-take-azure-exam-for-me/take-my-azure-az-305-exam-for-me",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Take Azure AZ-500 Exam for Me",
            url: "https://www.testhelpnow.com/pay-someone-to-take-azure-exam-for-me/take-my-azure-az-500-exam-for-me",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Take Azure DP-203 Exam for Me",
            url: "https://www.testhelpnow.com/pay-someone-to-take-azure-exam-for-me/take-my-azure-dp-203-exam-for-me",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
            name: "Take Azure AI-900 Exam for Me",
            url: "https://www.testhelpnow.com/pay-someone-to-take-azure-exam-for-me/take-my-azure-ai-900-exam-for-me",
          },
        },
      ],
    },
    audience: {
      "@type": "Audience",
      audienceType:
        "Students and professionals taking online Microsoft Azure proctored certification exams",
    },
  };
