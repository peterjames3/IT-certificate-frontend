    ...
    <section className="py-20 px-6 max-w-310 mx-auto w-full">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-base md:text-lg">
          Review our comprehensive support matrix to identify your specific
          EC-Council certification path and learn how pay someone to takey my ec-council and secure proctored  exam proxy services ensure a guaranteed passing outcome
          for your cybersecurity certification.
        </p>
      </div>
