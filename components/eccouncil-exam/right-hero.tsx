...
export default function HeroRight() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative bg-accent2  rounded-tl-none rounded-4xl flex flex-col justify-center w-full lg:w-1/2 px-6 py-8 md:py-12 lg:py-16 border border-gray-100 shadow-sm overflow-hidden"
      ...
      <div className="flex flex-col gap-6 w-full lg:w-1/2">
        ...
        <motion.div
          className="space-y-4 rounded-tl-none rounded-4xl bg-cardBg-support2 p-6 md:p-8 border border-gray-100 shadow-sm flex flex-col justify-between"
          variants={itemVariants}
        >
        ...
        <motion.div
          className="space-y-4 rounded-tl-none rounded-4xl bg-cardBg-support3 p-6 md:p-8 border border-gray-100 shadow-sm flex flex-col justify-between"
          variants={itemVariants}
        >
          <div className="space-y-3">
            <div className="flex items-center gap-3">
