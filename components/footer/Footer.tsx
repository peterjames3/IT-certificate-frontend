      ...
      <div className="grid md:grid-cols-4 gap-8 w-full mx-auto max-w-full lg:max-w-[1240px] xl:max-w-[1440px] pb-10">
        ...
        <div className="space-y-4">
          ...
          <p className="p-text text-gray-300">
            We are a one-stop solution for all your Proctored Online Exams. We
            offer flexible and customizable offer to all individuals depending
            on their educational qualification and certification they want to
            achieve.{" "}
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="hover:text-[#26A5E4] transition-colors"
            >
              Telegram
            </Link>
          </div>
