...
"use client";
import { CheckCircle, XCircle, Star, TrendingUp, Clock, DollarSign, Briefcase, RefreshCw, BookOpen } from "lucide-react";
    ...
    <div className="mt-10 space-y-8">
      ...
      <div className="overflow-x-auto rounded-xl border border-neutral-200 bg-white shadow-sm">
        <table className="w-full min-w-[640px]">
          ...
          <tbody>
            {/* Cost */}
            <SectionHeader icon={<DollarSign className="w-3.5 h-3.5" />} label="Cost" />
            <Row
              label="Exam fee"
            ...
            <Row
              label="Renewal cost"
              cells={certs.map((c) =>
                c.cost.renewalCostUSD ? `$${c.cost.renewalCostUSD}` : "Free / CPE"
              )}
            />
            <Row
              label="Total (year 1)"
            ...
            {/* Salary & Roles */}
            <SectionHeader icon={<TrendingUp className="w-3.5 h-3.5" />} label="Salary & Roles" />
            <Row
              label="Avg salary"
              cells={certs.map((c) => (
            ...
            {/* Renewal */}
            <SectionHeader icon={<RefreshCw className="w-3.5 h-3.5" />} label="Renewal" />
            <Row
              label="Valid for"
            ...
            {/* Domains */}
            <SectionHeader icon={<Briefcase className="w-3.5 h-3.5" />} label="Domains" />
            <Row
