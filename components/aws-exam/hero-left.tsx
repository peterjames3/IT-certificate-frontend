      ...
      <div>
        <div>
          <h2 className="text-sm font-semibold tracking-wider uppercase text-primary mb-2">
            Take AWS-Based Exams For Me
          </h2>

          <h3 className="text-2xl sm:text-[2.5rem] lg:text-[2.6rem] xl:text-[2.8rem] font-bold mb-6 leading-tight">
            <span className="text-secondary">
              Hire Verified AWS Experts To Take Your{" "}
            </span>
            <span className="text-[#10b981]"> AWS Exams </span>
          ...
          <p className="text-gray-600 mb-8 text-lg leading-relaxed">
            ...
            preparation, you can pay someone to take your Amazon Web Services
            ...
            <strong className="text-secondary font-medium">
              {" "}
              tracks like (CLF-C02),(SAA-C03), (SOA-C02), and Security Specialty
              (SCS-C02).
            </strong>{" "}
          </p>
