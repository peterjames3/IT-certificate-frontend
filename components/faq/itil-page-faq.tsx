...
export default function ItilFAQSection() {
  const [activeIndex, setActiveIndex] = useState<number | null>(null);

  const faqs = [
    {
      category: "ITIL 4 Foundation & Specialist Series",
    ...
    {
      category: "PeopleCert ExamShield & Proxy Compatibility",
    ...
    {
      category: "ITSM Architecture, Strategy & Support",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-secondary mb-3">
            ITIL Certification Assistance FAQ
          </h2>
          <p className="text-lg text-gray-600">
            Get explicit answers regarding secure environment setup, ExamShield
            safety, and scenario-based management evaluations.
          </p>
        </motion.div>
