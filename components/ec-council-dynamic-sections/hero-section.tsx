...
import type { HeroSectionData } from "@/app/(site)/pay-someone-to-take-ec-council-exam-for-me/[slug]/page";
...
const getSectionIcon = (title: string) => {
  switch (title.toLowerCase()) {
    ...
    case "cnd":
      return <Network className="text-blue-600" size={18} />;
    case "security analysis":
    case "ecsa":
      return <PenTool className="text-orange-500" size={18} />;
    case "digital forensics":
    case "chfi":
      return <Fingerprint className="text-red-500" size={18} />;
    case "cloud security":
    case "ccse":
      return <Cloud className="text-cyan-600" size={18} />;
    case "threat intelligence":
    case "ctia":
      return <Brain className="text-emerald-600" size={18} />;
    default:
